...
/**
 * This is the model class for table "t_nilai_rapor_kepribadian".
 *
 * The followings are the available columns in table 't_nilai_rapor_kepribadian':
 * @property string $NIS
 ...
 * @property RKepribadian $kDKEPRIBADIAN
 * @property Auth $uSERNAME
 */
class TNilaiRaporKepribadian extends CActiveRecord
{
	/**
	...
	{
		return 't_nilai_rapor_kepribadian';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('KD_PROGRAM_PENGAJARAN, KD_PERIODE_BELAJAR, KD_KEPRIBADIAN', 'length', 'max'=>1),
			...
			array('NIS, KD_TAHUN_AJARAN, KD_TINGKAT_KELAS, KD_PROGRAM_PENGAJARAN, KD_ROMBEL, KD_PERIODE_BELAJAR, KD_KEPRIBADIAN, KETERANGAN, USERNAME, TANGGAL_AKSES', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'kDKEPRIBADIAN' => array(self::BELONGS_TO, 'RKepribadian', 'KD_KEPRIBADIAN'),
	 ...
	 * @return TNilaiRaporKepribadian the static model class
	 */
