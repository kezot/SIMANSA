...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'columns' => array(
        array(
            ...
            'value' => 'CHtml::link($data->NIS, Yii::app()->createUrl("waliLihatPembayaran/view",array("NIS"=>$data->NIS, "KD_TAHUN_AJARAN"=>$data->KD_TAHUN_AJARAN, "KD_ROMBEL"=>$data->KD_ROMBEL, "KD_PROGRAM_PENGAJARAN"=>$data->KD_PROGRAM_PENGAJARAN, "KD_TINGKAT_KELAS"=>$data->KD_TINGKAT_KELAS)))'
            ),
        array(
            'header' => 'Nama',
            'name' => 'NIS',
