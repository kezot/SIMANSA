...
<div class="view">
	...
	'NIS'=>$data->NIS, 'KD_TAHUN_AJARAN'=>$data->KD_TAHUN_AJARAN, 'KD_TINGKAT_KELAS'=>$data->KD_TINGKAT_KELAS, 'KD_PROGRAM_PENGAJARAN'=>$data->KD_PROGRAM_PENGAJARAN, 'KD_ROMBEL'=>$data->KD_ROMBEL, 'KD_PERIODE_BELAJAR'=>$data->KD_PERIODE_BELAJAR, 'ID_EKSTRAKURIKULER'=>$data->ID_EKSTRAKURIKULER)); ?><br/></b>
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('ID_EKSTRAKURIKULER')); ?>:</b>
	<?php echo CHtml::encode($data->ID_EKSTRAKURIKULER); ?><br />
