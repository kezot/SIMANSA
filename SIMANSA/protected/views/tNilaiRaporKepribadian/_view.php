...
<div class="view">
	...
	'NIS'=>$data->NIS, 'KD_TAHUN_AJARAN'=>$data->KD_TAHUN_AJARAN, 'KD_TINGKAT_KELAS'=>$data->KD_TINGKAT_KELAS, 'KD_PROGRAM_PENGAJARAN'=>$data->KD_PROGRAM_PENGAJARAN, 'KD_ROMBEL'=>$data->KD_ROMBEL, 'KD_PERIODE_BELAJAR'=>$data->KD_PERIODE_BELAJAR, 'KD_KEPRIBADIAN'=>$data->KD_KEPRIBADIAN)); ?><br/></b>
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('KD_KEPRIBADIAN')); ?>:</b>
	<?php echo CHtml::encode($data->KD_KEPRIBADIAN); ?><br />
