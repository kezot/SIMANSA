<?php
/* @var $this PembayaranSiswaController */
$id_kelas = 0;
$nilai = 0;
$selected = '';
            ...
            <div class="row clearfix">
                <div class="col-md-9 column">
                    ...
                    <div class="btn-group">
                        ...
                        <form method="post" action="<?php echo htmlspecialchars(Yii::app()->request->baseUrl . '/index.php?r=pembayaranSiswa'); ?>">
                        ...
                        <tbody>
                            ...
                            if (isset($_POST['selectKelas']) && $id_kelas > 0) {
                                ...
                                for ($index1 = 0; $index1 < count($listSiswa); $index1++) {
                                    ...
                                    . '<td><a href="' . Yii::app()->request->baseUrl . '/index.php?r=pembayaranSiswa/crud&siswa=' . $listSiswa[$index1]->NIS . '">' . $listSiswa[$index1]->NM_SISWA . '</td></tr>';
                                }
                            }
                            ?>
                        </tbody>
