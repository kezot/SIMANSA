...
<div class="view">
    ...
    <b><?php echo CHtml::encode($data->getAttributeLabel('SAKIT')); ?>:</b>
	<?php echo CHtml::encode($data->SAKIT); ?><br />
	
    <b><?php echo CHtml::encode($data->getAttributeLabel('IJIN')); ?>:</b>
	<?php echo CHtml::encode($data->IJIN); ?><br />
	
    <b><?php echo CHtml::encode($data->getAttributeLabel('ABSEN')); ?>:</b>
	<?php echo CHtml::encode($data->ABSEN); ?><br />
	
    <b><?php echo CHtml::encode($data->getAttributeLabel('TANGGAL_DIBERIKAN')); ?>:</b>
	<?php echo CHtml::encode($data->TANGGAL_DIBERIKAN); ?><br />
	
    <b><?php echo CHtml::encode($data->getAttributeLabel('CATATAN')); ?>:</b>
	<?php echo CHtml::encode($data->CATATAN); ?><br />
	
    <b><?php echo CHtml::encode($data->getAttributeLabel('STATUS_ENTRY')); ?>:</b>
	<?php echo CHtml::encode($data->STATUS_ENTRY); ?><br />
