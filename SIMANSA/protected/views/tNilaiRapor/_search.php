...
<div class="wide form">
	...
	<div class="row">
		<?php echo $form->label($model,'SAKIT'); ?>
		<?php echo $form->textField($model,'SAKIT'); ?>
	</div>
	<div class="row">
		<?php echo $form->label($model,'IJIN'); ?>
		<?php echo $form->textField($model,'IJIN'); ?>
	</div>
	<div class="row">
		<?php echo $form->label($model,'ABSEN'); ?>
		<?php echo $form->textField($model,'ABSEN'); ?>
	</div>
	<div class="row">
		<?php echo $form->label($model,'TANGGAL_DIBERIKAN'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'STATUS_ENTRY'); ?>
